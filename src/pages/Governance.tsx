...
const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    image: rudi,
    category: "new_contributor",
    bio: "Rudi Plettinx brings extensive experience in strategic relationship building and institutional introductions. His network and discretion support SociisGroup's careful expansion and engagement with aligned leaders and organisations.",
  },
  {
    name: "Karim Tousbih",
          ...
          <div className="max-w-4xl">
            ...
            <div className="mb-24">
              ...
              <p className="text-body text-muted-foreground max-w-2xl mb-10">
                Independent collaborators across legal, production, strategic introductions, value development and standard-setting.
              </p>
