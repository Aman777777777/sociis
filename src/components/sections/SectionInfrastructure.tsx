      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="max-w-3xl space-y-6">
          <p className="text-body-lg text-foreground">
            Most organisations lose value through inconsistent decisions.
          </p>
          <p className="text-body-lg text-foreground">
            We intervene before those decisions are made.
          </p>
          <p className="font-accent text-xl sm:text-2xl text-foreground italic">
            Behaviour is the missing B in ESG.
          </p>
          <p className="text-body text-muted-foreground">
            SociisGroup builds the infrastructure that improves behaviour before outcomes exist.
          </p>
        </div>
      </div>
    </section>
