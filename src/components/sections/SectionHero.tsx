      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-1 text-center lg:text-left">
            ...
            >
              <span className="font-medium">SociisGroup™</span> is a sovereign independent behavioural institution and benefit corporation building behavioural infrastructure for sustainability, hospitality and humanity, making Impact at Scale real and accountable.
            </p>
            <p 
