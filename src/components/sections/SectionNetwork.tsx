        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-12 lg:mb-16 items-center">
            <div className="opacity-0 animate-[fade-in_0.8s_ease-out_forwards]">
              ...
              <h2 className="font-sans font-light text-3xl sm:text-4xl text-foreground tracking-tight mb-4 sm:mb-6">
                Sociis Network™
              </h2>
              <div className="w-16 h-px bg-gradient-to-r from-accent to-transparent mb-6 sm:mb-8"></div>
            ...
            <div className="relative group opacity-0 animate-[fade-in_0.8s_ease-out_0.2s_forwards]">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-3 -left-3 w-8 sm:w-12 h-8 sm:h-12 border-l-2 border-t-2 border-accent/40"></div>
            </div>
          </div>
